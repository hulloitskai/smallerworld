...
class Event
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Event` class because it declared `has_many :shares`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::EventShare::PrivateCollectionProxy) }
    def shares; end

    sig { params(value: T::Enumerable[::EventShare]).void }
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(value: ::String).returns(::String) }
    def registration_url=(value); end

    sig { returns(T::Boolean) }
    def registration_url?; end

    sig { returns(T.nilable(::String)) }
    def registration_url_before_last_save; end

    sig { returns(T.untyped) }
    def registration_url_before_type_cast; end

    sig { returns(T::Boolean) }
    def registration_url_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def registration_url_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def registration_url_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def registration_url_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def registration_url_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def registration_url_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def registration_url_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def registration_url_previously_was; end

    sig { returns(T.nilable(::String)) }
    def registration_url_was; end

    sig { void }
    def registration_url_will_change!; end
    ...
    sig { void }
    def restore_registration_url!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_registration_url; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_registration_url?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_registration_url?(from: T.unsafe(nil), to: T.unsafe(nil)); end
