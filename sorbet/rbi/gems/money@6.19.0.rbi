...
class Money
  ...
  # @return [Array<Money>]
  #
  # source://money//lib/money/money.rb#599
  def split(parts); end
  ...
  class << self
    ...
    # source://money//lib/money/money.rb#316
    ...
    # @see #initialize
    #
    # source://money//lib/money/money.rb#317
...
module Money::Constructors
  ...
  # @return [Money]
  #
  # source://money//lib/money/money/constructors.rb#32
  def cad(cents); end
  ...
  # @return [Money]
  #
  # source://money//lib/money/money/constructors.rb#65
  def eur(cents); end
  ...
  # @return [Money]
  #
  # source://money//lib/money/money/constructors.rb#81
  def gbp(pence); end
  ...
  # @return [Money]
  #
  # source://money//lib/money/money/constructors.rb#49
  def usd(cents); end
  ...
  # @return [Money]
  #
  # source://money//lib/money/money/constructors.rb#15
...
class Money::Currency
  ...
  # source://money//lib/money/currency.rb#264
  def eql?(_arg0); end
  ...
  #   whole unit from the subunit.
  #
  # source://money//lib/money/currency.rb#262
  def separator; end
...
class Money::Formatter
  ...
  # source://money//lib/money/money/formatter.rb#259
  def separator; end
