...
// import HomeScreenPreview from "./WorldHomescreenPreview";
// import { openUserWorldPageInstallationInstructionsModal } from "./UserWorldPageInstallationInstructionsModal";

// export interface UserWorldPageInstallModalProps
//   extends Omit<ModalBodyProps, "modalId"> {}

// export const openUserWorldPageInstallModal = (
//   props: UserWorldPageInstallModalProps,
// ): void => {
...
//               } else {
//                 openUserWorldPageInstallationInstructionsModal({ currentUser });
//                 closeModal(modalId);
//               }
//             } else {
